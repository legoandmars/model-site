...
function Post(_ref) {
  ...
  function previousImage() {
    if (postData.extra_images.indexOf(selected) == 0) {
      setSelected(postData.extra_images[postData.extra_images.length - 1].image);
    } else {
      setSelected(postData.extra_images[postData.extra_images.indexOf(selected) - 1].image);
    }
  }
...
//# sourceMappingURL=[id].js.2a2bc515b4fb46d7c590.hot-update.js.map