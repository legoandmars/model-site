...
function Post(_ref) {
  ...
  function previousImage() {
    console.log(postData.extra_images.indexOf(selected));

    if (postData.extra_images.indexOf(selected) == 0) {
      setSelected(postData.extra_images[postData.extra_images.length]);
    } else {
...
//# sourceMappingURL=[id].js.26104feb78b9995c737f.hot-update.js.map