...
function Post(_ref) {
  ...
  if (postData.extra_images) {
    if (postData.extra_images[0] != postData.image_name) {
      postData.extra_images.unshift(postData.image_name);
    }

    imageArray = postData.extra_images;
  }

  var imageIndex = 0;

  var _React$useState = react__WEBPACK_IMPORTED_MODULE_1___default.a.useState(imageArray[0]),
  ...
  function nextImage() {
    ...
    if (imageArray == imageArray.length) {
      setSelected(imageArray[0]);
    } else {
      imageIndex++;
      setSelected(imageArray[imageIndex]);
    }
  }
...
//# sourceMappingURL=[id].js.ebb9c653e3d5c72dd9a9.hot-update.js.map