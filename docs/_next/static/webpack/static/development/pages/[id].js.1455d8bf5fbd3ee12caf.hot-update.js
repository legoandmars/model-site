...
function Post(_ref) {
  ...
  var imageArray = postData.extra_images;
  var imageIndex = 0;
  var selectedImage = postData.image_name;
  if (postData.extra_images) imageArray = postData.extra_images;
  imageArray.unshift(postData.image_name);

  var _React$useState = react__WEBPACK_IMPORTED_MODULE_1___default.a.useState(selectedImage),
  ...
  function nextImage() {
    ...
    if (imageArray == imageArray.length) {
      selectedImage = postData.extra_images[0];
      setSelected(selectedImage);
    } else {
      imageIndex++;
      selectedImage = postData.extra_images[imageIndex];
      setSelected(selectedImage);
    }
  }
...
//# sourceMappingURL=[id].js.1455d8bf5fbd3ee12caf.hot-update.js.map