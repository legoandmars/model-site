...
function Post(_ref) {
  ...
  var _React$useState = react__WEBPACK_IMPORTED_MODULE_1___default.a.useState(postData.extra_images[0]),
  ...
  function nextImage() {
    if (imageIndex == postData.extra_images.length) {
      imageIndex = 0;
      setSelected(postData.image_name);
    } else {
      imageIndex++;
      setSelected(postData.extra_images[imageIndex - 1]);
    }
  }
...
//# sourceMappingURL=[id].js.6f1aac96952e6a3c4d00.hot-update.js.map